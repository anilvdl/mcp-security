...
```groovy
implementation("org.springaicommunity:mcp-server-security-spring-boot:0.1.11")
```
...
```groovy
implementation("org.springaicommunity:mcp-client-security-spring-boot:0.1.11")
...
```groovy
implementation("org.springaicommunity:mcp-client-security:0.1.11")
```
...
```groovy
implementation("org.springaicommunity:mcp-authorization-server-spring-boot:0.1.11")
```
...
```groovy
implementation("org.springaicommunity:mcp-authorization-server:0.1.11")
```
