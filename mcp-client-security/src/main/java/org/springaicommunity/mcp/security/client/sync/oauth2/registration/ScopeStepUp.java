...
/**
 * Scope Step Up flow support for MCP.
 *
 ...
 * Authorization</a>
 */
public class ScopeStepUp {

	private static final Logger log = LoggerFactory.getLogger(ScopeStepUp.class);

	protected final McpClientRegistrationRepository repository;

	public ScopeStepUp(McpClientRegistrationRepository repository) {
		this.repository = repository;
	}

	/**
	 * Update scopes of an OAuth2 client based on a {@code WWW-Authenticate} header.
	 * @param registrationId the ID of the OAuth2 client to update
	 * @param wwwAuthenticateHeader the WWW-AUthenticate header
	 * @return true if the client was updated, false otherwise
	 */
	public boolean updateOAuth2ClientScopes(String registrationId, String wwwAuthenticateHeader) {
